...
==================================================
- 'runanalysis.R': R file giving code for tidy data set project

- 'tidydata.txt': Tidy data set which summarizes average values for each activity and each subject
